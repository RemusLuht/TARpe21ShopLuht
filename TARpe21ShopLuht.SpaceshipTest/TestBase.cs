...
using TARpe21ShopLuht.SpaceshipTest.Macros;
using Microsoft.Extensions.Hosting;
using TARpe21ShopLuht.SpaceshipTest.Mock;

namespace TARpe21ShopLuht.SpaceshipTest
{
    public abstract class TestBase
    {
        ...
        public virtual void SetupServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<TARpe21ShopLuhtContext>
                (x =>
                {
